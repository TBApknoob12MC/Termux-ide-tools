...
apt install zsh jq fzf sl cowsay make mpv ffmpeg nmap tmux proot-distro asciinema cmatrix fortune libcaca gnupg unzip neovim hexcurse hyperfine git tig python3 ruby rust gotty glow gum swi-prolog pforth wget figlet nodejs newsboat irssi lynx -y
gem install lolcat
