...
apt install zsh sl cowsay make mpv ffmpeg nmap tmux proot-distro asciinema cmatrix fortune libcaca gotty gnupg unzip neovim hexcurse hyperfine git tig python3 ruby rust golang glow gum wget figlet nodejs newsboat irssi lynx -y
gem install lolcat
